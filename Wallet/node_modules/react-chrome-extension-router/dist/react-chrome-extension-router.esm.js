...
function Link(_ref) {
  ...
  var onClickHandler = useCallback(function (evt) {
    evt.preventDefault();
...
export { Link, NavLink, Router, getComponentStack, getCurrent, goBack, goTo, popToTop };
//# sourceMappingURL=react-chrome-extension-router.esm.js.map
